...
**Status:** accepted (2026-09-08), from ai.ctf issue #60 ("connect outsiders / bring your own agent"). design in `docs/external-entrants.md`; research in `docs/research/byoa-*.md`
