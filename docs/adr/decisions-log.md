...
## ADR-0023 — external entrants attach over a plain HTTPS agent API; the substrate switch moves from the run to the entrant
...
## ADR-0024 — wallet credentials and five arena tools replace external raw activity

**Status:** accepted (2026-09-09). updates ADR-0023 for external credentials, reporting, and status. design in `docs/external-entrants.md`; wire contract in `contract/API.md`.
